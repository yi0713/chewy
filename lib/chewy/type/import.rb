      ...
      private
        ...
        def bulk_body(action_objects, indexed_objects = nil)
          action_objects.inject([]) do |result, (action, objects)|
            ...
            stash = Chewy::Type::Chains::Stash.new(self, objects) if action == :index
            result.concat(objects.map { |object| send(method, object, indexed_objects, stash) }.flatten)
          end
        end

        def delete_bulk_entry(object, indexed_objects = nil, stash = nil)
          entry = {}
        ...
        def index_bulk_entry(object, indexed_objects = nil, stash = nil)
          entry = {}
          ...
          entry[:data] = object_data(object, stash)
        ...
        def object_data object, stash = nil
          (self.root_object ||= build_root).compose(object, [], stash)[type_name.to_sym]
        end
